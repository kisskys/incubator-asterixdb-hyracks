...
import edu.uci.ics.hyracks.storage.am.lsm.common.impls.AbstractLSMMergeOperation;

public class LSMBTreeWithBuddyMergeOperation extends AbstractLSMMergeOperation {
    ...
    public LSMBTreeWithBuddyMergeOperation(ILSMIndexAccessorInternal accessor, List<ILSMComponent> mergingComponents,
            ...
            boolean keepDeletedTuples, Object mergePolicyInfo) {
