...
import edu.uci.ics.hyracks.storage.am.lsm.rtree.tuples.LSMRTreeTupleWriterFactoryForPointMBR;
...
public class LSMRTreeUtils {
    public static LSMRTree createLSMTree(List<IVirtualBufferCache> virtualBufferCaches, FileReference file,
            ...
            boolean isPointMBR) throws TreeIndexException {
        ...
        LSMRTree lsmTree = new LSMRTree(virtualBufferCaches, rtreeInteriorFrameFactory, rtreeLeafFrameFactory,
                ...
                buddyBTreeFields, filterFields, isPointMBR);
        return lsmTree;
    }
    ...
    public static LSMRTreeWithAntiMatterTuples createLSMTreeWithAntiMatterTuples(
        ...
        if (isPointMBR) {
            ...
            rtreeLeafFrameTupleWriterFactory = new LSMRTreeTupleWriterFactoryForPointMBR(typeTraits,
                    keyFieldCount, valueFieldCount, true);
            rtreeLeafFrameCopyTupleWriterFactory = new LSMRTreeTupleWriterFactoryForPointMBR(typeTraits,
                    keyFieldCount, valueFieldCount, true);
        ...
        ITreeIndexFrameFactory rtreeInteriorFrameFactory = new RTreeNSMInteriorFrameFactory(rtreeInteriorFrameTupleWriterFactory,
                valueProviderFactories, rtreePolicyType, isPointMBR);
        ITreeIndexFrameFactory rtreeLeafFrameFactory = new RTreeNSMLeafFrameFactory(rtreeLeafFrameTupleWriterFactory,
                valueProviderFactories, rtreePolicyType, isPointMBR);
        ...
        ITreeIndexFrameFactory copyTupleLeafFrameFactory = new RTreeNSMLeafFrameFactory(rtreeLeafFrameCopyTupleWriterFactory,
                valueProviderFactories, rtreePolicyType, isPointMBR);
        ...
        LSMRTreeWithAntiMatterTuples lsmTree = new LSMRTreeWithAntiMatterTuples(virtualBufferCaches,
                ...
                ioOpCallback, rtreeFields, filterFields, isPointMBR);
        return lsmTree;
    }
    ...
    public static ExternalRTree createExternalRTree(FileReference file, IBufferCache diskBufferCache,
        ...
        ExternalRTree lsmTree = new ExternalRTree(rtreeInteriorFrameFactory, rtreeLeafFrameFactory,
                ...
                mergePolicy, opTracker, ioScheduler, ioOpCallback, buddyBTreeFields, startWithVersion, isPointMBR);
        return lsmTree;
    }
